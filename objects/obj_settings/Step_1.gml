...
{	
	global.arriba = keyboard_check_pressed(vk_up);
	global.abajo = keyboard_check_pressed(vk_down);
	global.izquierda = keyboard_check(vk_left);
	global.derecha = keyboard_check(vk_right);
	...
	global.ataque = keyboard_check_pressed(ord("A"));
